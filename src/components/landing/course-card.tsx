...
export function CourseCard({ course }: { course: PublicCourse }) {
  ...
  return (
    <div className="flex flex-col gap-3 border border-edu-navy/15 border-t-2 border-t-edu-teal bg-white p-6">
      ...
      <Link
        href="/training"
        className={`mt-1 inline-flex min-h-11 items-center justify-center rounded bg-edu-gold px-5 py-2.5 text-sm font-bold text-edu-navy ${FOCUS_RING}`}
      >
        Register
      </Link>
    </div>
