  ...
  return (
    <PolicyLayout>
      <div className="flex flex-col gap-2">
        <h1 className="font-heading text-3xl text-brand-navy">Terms and Conditions</h1>
      ...
      <div className="mt-10 flex flex-col gap-10 text-base leading-relaxed text-brand-navy sm:mt-12 sm:gap-12 sm:text-lg sm:leading-loose">
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">1. The operator</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">2. Eligibility</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">3. Accuracy of information</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">4. Conduct during training</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">5. Intellectual property</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">6. Limitation of liability</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">7. Cancellations and refunds</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">8. Changes to these terms</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">9. Governing law</h2>
