  ...
  return (
    <PolicyLayout>
      <div className="flex flex-col gap-2">
        <h1 className={POLICY_TITLE}>Digital Delivery Policy</h1>
      ...
      <div className="mt-10 flex flex-col gap-10 text-base leading-relaxed text-edu-navy sm:mt-12 sm:gap-12 sm:text-lg sm:leading-loose">
        ...
        <section className="flex flex-col gap-3">
          <h2 className={POLICY_SECTION_HEADING}>2. Confirmation email</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className={POLICY_SECTION_HEADING}>3. Joining instructions</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className={POLICY_SECTION_HEADING}>4. Course materials</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className={POLICY_SECTION_HEADING}>5. Recording</h2>
          <p>No session is recorded. No recordings or replays are provided.</p>
        </section>

        <section className="flex flex-col gap-3">
          <h2 className={POLICY_SECTION_HEADING}>6. Certificates</h2>
          <p>
