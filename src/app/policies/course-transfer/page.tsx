  ...
  return (
    <PolicyLayout>
      <div className="flex flex-col gap-2">
        <h1 className={POLICY_TITLE}>Course Transfer Policy</h1>
      ...
      <div className="mt-10 flex flex-col gap-10 text-base leading-relaxed text-edu-navy sm:mt-12 sm:gap-12 sm:text-lg sm:leading-loose">
        ...
        <section className="flex flex-col gap-3">
          <h2 className={POLICY_SECTION_HEADING}>2. Deadline</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className={POLICY_SECTION_HEADING}>3. How to request a transfer</h2>
          <p>
            Email{' '}
        ...
        <section className="flex flex-col gap-3">
          <h2 className={POLICY_SECTION_HEADING}>4. Price differences and credit</h2>
          <p>
