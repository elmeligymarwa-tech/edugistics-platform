  ...
  return (
    <PolicyLayout>
      <div className="flex flex-col gap-2">
        <h1 className="font-heading text-3xl text-brand-navy">Certificate Policy</h1>
      ...
      <div className="mt-10 flex flex-col gap-10 text-base leading-relaxed text-brand-navy sm:mt-12 sm:gap-12 sm:text-lg sm:leading-loose">
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">1. Accreditation</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">2. What the certificate records</h2>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">3. Receiving your certificate</h2>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">4. Substitutes</h2>
          <p>
