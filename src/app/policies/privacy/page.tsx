  ...
  return (
    <PolicyLayout>
      <div className="flex flex-col gap-2">
        <h1 className="font-heading text-3xl text-brand-navy">Privacy Policy</h1>
      ...
      <div className="mt-10 flex flex-col gap-10 text-base leading-relaxed text-brand-navy sm:mt-12 sm:gap-12 sm:text-lg sm:leading-loose">
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">1. What we collect</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">2. Why we collect it</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">3. Marketing communications</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">4. How long we keep your information</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">5. Deletion</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">6. Sharing your information</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">7. Cookies and analytics</h2>
          <p>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="font-heading text-xl sm:text-2xl">8. Contact</h2>
          <p>
